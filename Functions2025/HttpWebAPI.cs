...
[HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "students")] HttpRequestData req)
    ...
    (
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "students/school/{id}")] HttpRequestData req,
        int id
    )
    {
    ...
    (
        ...
        string school)
    {
        _logger.LogInformation("C# HTTP GET trigger function processed a request in GetStudentsBySchool().");
